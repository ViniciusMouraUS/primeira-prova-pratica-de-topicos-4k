...
public class CondominioDAO {
    ...
    public static final String COLUNA_POSITSP = "positsp";
    public static final String CRIAR_TABELA = "CREATE TABLE "+NOME_TABELA+"("+COLUNA_ID+" INTEGER PRIMARY KEY AUTOINCREMENT NOT" +
            ...
            COLUNA_AREATOTAL+" TEXT, " + COLUNA_POSITSP + " INTEGER)";
    ...
    public ArrayList<Condominio> listar(){
        ...
        int indicePosItSpinner = cursor.getColumnIndex(COLUNA_POSITSP);
        ...
        while(cursor.moveToNext()){
            ...
            condominio.setPosicaoItemSpinner(cursor.getInt(indicePosItSpinner));
    ...
    public ContentValues condominioContentValues(Condominio condominio){
        ...
        cv.put(COLUNA_POSITSP, condominio.getPosicaoItemSpinner());
